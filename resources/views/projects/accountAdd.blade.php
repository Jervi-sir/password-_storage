<x-app-layout>
    @if (session('alert'))
      ...
      <x-auth-card>
          ...
          <form method="POST" action="{{ route('projectAccount.upload') }}">
              @csrf
            ...
            <div class="mt-4">
                ...
                <x-input id="text" disabled class="bg-gray-100 block mt-1 w-full" value="{{ $project->project_name }}" type="text" required />
            </div>
